...
namespace labo61
{
    class Programme61
    {
        static void Main()
        {
            Console.WriteLine("entrez 5 nombres");
            int total = 0;
    ...
    class program
    {
        static void Main()
        {
            ...
            do
            {
                ...
                Console.WriteLine("entrez un nombre"); nombre = int.Parse(Console.ReadLine());
               
                Console.WriteLine("entrez la puissance"); puissance = int.Parse(Console.ReadLine());
                
                Console.WriteLine(Power(nombre, puissance));
                
                Console.WriteLine("voulez vous arreter ? y/n");stop = Console.ReadLine();
